...
title: Cover Images & Brand Assets
permalink: /media/cover-images/
intro: Official cover images and brand assets for media, interviews, features, and promotional use.
---

## Cover Images & Brand Assets

This page holds the official visual assets for **Unschool Discoveries**. These materials may be used for media coverage, interviews, podcasts, articles, event listings, and other approved promotional uses.
...
- press coverage
- podcast and interview promotions
- event listings
- review features
- articles and media mentions

Please do not alter the artwork, stretch the images, or apply unapproved filters or overlays.
...
Created by **Danii Oliver**

## Need Something Else?

For additional sizes, special requests, or other media needs, use the [media contact form]({{ site.mediaContactUrl }}).